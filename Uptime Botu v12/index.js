...
[Ekleme Linkim](https://discord.com/api/oauth2/authorize?client_id=980527101008552007&permissions=8&scope=bot)

[Destek Sunucum](https://discord.gg/K5KG7VXKSj)

[Sitemiz](https://ruddy-surf-kilogram.glitch.me)
==================================
**`)
  .setThumbnail(message.author.avatarURL())
...
📞 » [${prefix}ekle](https://discord.gg/K5KG7VXKSj) Link Eklemenize Yarar
📞 » [${prefix}erişim-kontrol](https://discord.gg/K5KG7VXKSj) Erişim Kontrol
📞 » [${prefix}linkler](https://discord.gg/K5KG7VXKSj) Liklerinizi Gösterir
`)
  .addField('**Hakkında**',`
...
==================================
> 📘 » [Destek Server](https://discord.gg/K5KG7VXKSj)
> 📘 » [Eklemek İçin](https://discord.com/api/oauth2/authorize?client_id=980527101008552007&permissions=8&scope=bot)`)
.setThumbnail('https://share.creavite.co/fZCsyS0A0SEB9Ruz.gif')
...
client.on('ready', () => {
client.user.setActivity(`Buuenx💖BX`, { type: 'WATCHING' })
